...
const ONGLETS: { cle: CleOnglet; libelle: string; emoji: string }[] = [
  ...
  { cle: "question", libelle: "Poser une question", emoji: "💬" },
];
...
export default function EcranGuideDetail() {
  ...
  return (
    <Ecran>
      ...
      {onglet === "question" ? (
        <OngletQuestion guide={guide} etapes={etapes} />
      ) : null}
...
// =============================================================================
// =============================================================================
// Onglet « Poser une question ».
//
// Le formulaire vit dans components/assistant.tsx : la feuille du bouton
// flottant l'utilise aussi, et deux copies divergeraient à la première
// correction — or ce qui divergerait, ce sont les quatre cas de réponse et la
// lecture du 429, c'est-à-dire ce qu'on peut le moins se permettre de traiter
// différemment d'un écran à l'autre.
//
// Ce qui reste ici est ce que seul cet écran sait faire : tirer les
// suggestions du guide affiché et de ses étapes, déjà chargées. Devant un
// champ vide, beaucoup ne savent pas quoi demander, et une question posée au
// hasard a toutes les chances d'être refusée.
// =============================================================================
function OngletQuestion({
  guide,
  etapes,
}: {
  guide: Guide;
  ...
  const suggestions = useMemo(
    () => questionsSuggerees(guide, etapes),
    [guide, etapes],
  );

  return (
    <FormulaireAssistant
      itineraireId={guide.itineraire_id}
